...
requirements = python3,kivy,kivymd,boto3,plyer,pymysql,botocore==1.32.6,certifi==2023.11.17,java,charset-normalizer==3.3.2,docutils==0.20.1,filelock==3.13.1,idna==3.5,jmespath==1.0.1,pillow,platformdirs==4.0.0,ptyprocess==0.7.0,Pygments==2.17.2,python-dateutil==2.8.2,requests==2.31.0,s3transfer==0.7.0,virtualenv==20.24.7,dislib==0.3.0
